...
public class SendPostDemo2 {
    public static void main(String[] args) throws Exception {
        String urlPath = new String("http://127.0.0.1:21100/http");
        String param = "{\"pub_info\":{\"imp_type\":\"IVRTwoConfirm\",\"sys_op_id\":\"ywdt\",\"sys_password\":\"9A5696B73B141F6DCF90F35C2BAF855E\"},\"busi_info\":{\"content\":\"即将为13988893993办理30元流量套餐业务，确认办理请按1，重听请按9\",\"vcid\":\"572\"}}";
        // 建立连接
